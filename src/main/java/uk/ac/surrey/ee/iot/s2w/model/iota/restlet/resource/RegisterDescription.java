...
import uk.ac.surrey.ee.iot.s2w.associations.IotaAssociationMatcher;
...
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.response.S2WRegistrationResponse;
import uk.ac.surrey.ee.iot.s2w.probengine.handler.FoldInHandler;
import uk.ac.surrey.ee.iot.s2w.associations.Geohash;
...
//                .get("org.restlet.ext.servlet.ServletContext");
        ...
        if (cp.getObjType().equalsIgnoreCase(EntityConfigParams.objType)) {
            ...
            IotaAssociationMatcher iotaAssocGen = new IotaAssociationMatcher(cp, context);
