 ...
 */
package uk.ac.surrey.ee.iot.s2w.coap;
...
import uk.ac.surrey.ee.iot.s2w.coap.resource.CoapDeleteDescription;
import uk.ac.surrey.ee.iot.s2w.coap.resource.CoapQueryDescription;
import uk.ac.surrey.ee.iot.s2w.coap.resource.CoapDiscoverDescription;
import uk.ac.surrey.ee.iot.s2w.coap.resource.CoapRegisterDescription;
import uk.ac.surrey.ee.iot.s2w.coap.resource.HelloWorldResource;
import uk.ac.surrey.ee.iot.s2w.coap.resource.CoapLookupDescription;
import uk.ac.surrey.ee.iot.s2w.coap.resource.CoapUpdateDescription;
import java.io.File;
...
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.RestReqApplication;
