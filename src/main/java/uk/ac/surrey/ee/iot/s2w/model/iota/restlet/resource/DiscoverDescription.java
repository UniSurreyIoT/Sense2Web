 ...
 */
package uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource;
...
import uk.ac.surrey.ee.iot.s2w.config.Parameters;
import uk.ac.surrey.ee.iot.s2w.jena.JenaModelMgmt;
import uk.ac.surrey.ee.iot.s2w.jena.sdb.SdbAccessHandler;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.response.ClientAcceptFormatter;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.response.S2W_ETStatusResponse;
import uk.ac.surrey.ee.iot.s2w.probengine.core.NonLogicMatchmaking;
import uk.ac.surrey.ee.iot.s2w.probengine.core.ObjectDataStructure;
...
//        ServletContext context = (ServletContext) getContext().getServerDispatcher().getContext().getAttributes().get("org.restlet.ext.servlet.ServletContext");
        ServletContext context = ETContextListener.servletContext;
