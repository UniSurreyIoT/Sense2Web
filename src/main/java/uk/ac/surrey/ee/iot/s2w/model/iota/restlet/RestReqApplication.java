 ...
 */
package uk.ac.surrey.ee.iot.s2w.model.iota.restlet;

import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.DeleteDescription;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.RegisterDescription;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.QueryDescription;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.SanityCheck;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.UpdateDescription;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.DiscoverDescription;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.LookupDescription;
import org.restlet.Application;
import org.restlet.Restlet;
import org.restlet.routing.Router;
import uk.ac.surrey.ee.iot.s2w.config.EntityConfigParams;
import uk.ac.surrey.ee.iot.s2w.config.ResourceConfigParams;
import uk.ac.surrey.ee.iot.s2w.config.ServiceConfigParams;
import uk.ac.surrey.ee.iot.s2w.model.iota.restlet.resource.RegisterMultiple;
