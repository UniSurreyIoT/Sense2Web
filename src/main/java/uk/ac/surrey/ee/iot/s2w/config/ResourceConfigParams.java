package uk.ac.surrey.ee.iot.s2w.config;
...
//    public static final String mysql_db_url = "jdbc:mysql://localhost:3306/resourcedb";
    public static final String mysql_db_url = "resourcedb";
    ...
    public String getMysqlDbUrl() {
        String address = context.getInitParameter("address_mysql");
        if (address.endsWith("/")) {
            address = address + mysql_db_url;
        } else {
            address = address + "/" + mysql_db_url;
        }
